...
class QuickCountIndexer {
  ...
  electionDetail(eid, method = 'latest') {
    ...
    return {
      election: { eid: el.eid, name: el.name, orgAddr: el.orgAddr, orgName: org ? org.name : null, orgActive: org ? org.active : false, createdAt: el.createdAt, closed: el.closed || false },
      method,
