...
class QuickCountIndexer {
  ...
  _structural(tx, env, kind, at) {
    ...
    // Structural changes come from the election's org: Owner, Administrator, or Moderator.
  ...
  electionDetail(eid, method = 'latest') {
    ...
    return {
      election: { eid: el.eid, name: el.name, orgAddr: el.orgAddr, orgName: org ? org.name : null, orgActive: org ? org.active : false, orgJur: org ? (org.jur || '') : '', createdAt: el.createdAt },
      method,
